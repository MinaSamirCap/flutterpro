...
class CompanyDetailsIntroAnimation {
  CompanyDetailsIntroAnimation(this.controller)
      : bgdropOpacity = Tween(begin: 0.5, end: 1.0).animate(CurvedAnimation(
        ...
        bgdropBlur = Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: controller,
            curve: Interval(0.000, 0.999, curve: Curves.ease))),
        ...
        dividerWidth = Tween(begin: 0.0, end: 225.0).animate(CurvedAnimation(
            parent: controller,
            curve: Interval(0.650, 0.650, curve: Curves.elasticInOut))),
        aboutOpacity = Tween(begin: 0.0, end: 0.85).animate(CurvedAnimation(
            parent: controller,
            curve: Interval(0.750, 0.900, curve: Curves.easeIn))),
        courseScrollerXTranslation = Tween(begin: 60.0, end: 0.0).animate(CurvedAnimation(
            parent: controller,
            curve: Interval(0.830, 1.0, curve: Curves.ease))),
        courseScrollerOpacity = Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: controller,
